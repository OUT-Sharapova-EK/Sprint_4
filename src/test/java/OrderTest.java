...
public class OrderTest {
    ...
    public OrderTest (String userName, String userLastName, String userAddress, String userMetroStation, String userPhone, String dataRent, String rentalPeriod, String checkboxColor, String userComment, String expected) {
    ...
    public static Object[][] settingFAQ() {
        return new Object[][]{
                {"Иван", "Иванов", "Г.Видное, ул. Строительная, д.24", "Царицыно", "71231231212", TODAY_DATE_RENT, "сутки", "чёрный жемчуг", "комментарий", "Заказ оформлен"},
                {"Петр", "Петров", "Адрес хоть какой-тоОйеЁ", "Бульвар Дмитрия Донского", "+70000000000", TOMORROW_DATE_RENT, "семеро суток", "серая безысходность", " ", "Заказ оформлен"},
        };
    }
